...
class Sidebar(QWidget):
    ...
    def __init__(self):
        ...
        self.tree_view.setHorizontalScrollBarPolicy(
            Qt.ScrollBarPolicy.ScrollBarAsNeeded)  # Горизонтальная прокрутка при необходимости
        self.tree_view.setVerticalScrollBarPolicy(
            Qt.ScrollBarPolicy.ScrollBarAsNeeded)  # Вертикальная прокрутка при необходимости
        self.tree_view.setSizePolicy(QSizePolicy.Policy.Expanding,
